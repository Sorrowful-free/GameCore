...
using Core.Runtime.ClassTypeReference;
using UnityEditor;
using UnityEngine;

namespace Core.Editor.ClassTypeReference {

	/// <summary>
	/// Custom property drawer for <see cref="ClassTypeReference"/> properties.
	/// </summary>
	[CustomPropertyDrawer(typeof(global::Core.Runtime.ClassTypeReference.ClassTypeReference))]
	...
	public sealed class ClassTypeReferencePropertyDrawer : PropertyDrawer {
		...
		private static void OnSelectedTypeName(object userData) {
			...
			s_SelectedClassRef = global::Core.Runtime.ClassTypeReference.ClassTypeReference.GetClassRef(selectedType);
